...
public class ProjectSteps {
	...
	public void i_click_new_project_from_the_project_list_screen_and_submit_the_following_values(DataTable arg1) throws Throwable {
	...
	public void on_the_project_page_for_there_should_be_a_link_to_a_sprint_called(String arg1, String arg2) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^the \"([^\"]*)\" link should navigate me to an \"([^\"]*)\" sprint called \"([^\"]*)\"$")
	public void the_link_should_navigate_me_to_an_sprint_called(String arg1, String arg2, String arg3) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^on the \"([^\"]*)\" there should be a link for Project Burndown that shows me the project burndown$")
	public void on_the_there_should_be_a_link_for_Project_Burndown_that_shows_me_the_project_burndown(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^the project burndown should consist of (\\d+) sprints, each totalling (\\d+) story point effort remaining$")
	public void the_project_burndown_should_consist_of_sprints_each_totalling_story_point_effort_remaining(int arg1, int arg2) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^on \"([^\"]*)\" there should be a link for Sprint Burndown that shows me the sprint burndown$")
	public void on_there_should_be_a_link_for_Sprint_Burndown_that_shows_me_the_sprint_burndown(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
